...
# 2 bilgi değişkenindeki metin kaç cüml
paragraflar = (bilgi.split("."))
print(len(paragraflar))
# 3 bilgiyi çevir
...
# meyve isimlerini listeye dönüştürün isimlerini alfabetik olarak sıralayın
...
# 6 ogrenciler listesinin 3 numaralı indise sahip elemanı BEKIRI silin.
ogrenciler.pop(3)
print(ogrenciler)
