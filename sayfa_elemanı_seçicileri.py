...
aile_birliği = tarayici.find_element(By.PARTIAL_LINK_TEXT, "Aile Birliği")
aile_birliği.click()
sleep(2)
# etiket adı ile elemana ulaşalım
linkler = tarayici.find_element(By.TAG_NAME, "a")
print(len(linkler))
#XPAT seçici ile elemana ulaşalım
