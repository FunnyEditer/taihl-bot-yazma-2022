...
#futbolcuların 5 gol ve 8 assist üzerinde olanları başarılı sayalım
futbolcu1  = {
    "gol":5,
    "assist":9
}
...
print(f"1. futbolcu: {(futbolcu1['gol'] > 5 and futbolcu1['assist'] > 8)}")
print(f"2. futbolcu: {(futbolcu2['gol'] > 5 and futbolcu2['assist'] > 8)}")
