...
#sets listenisin içindeki bir elemana ulaşalım
#print(sets_liste[0]) #hata verdi

# sets liste elemanlarına döngüsü ile ulaşalım
...
#tekraralayan elemanı olan bir listeyi sets listesine dönüştürelim set()
liste = [1,1,5,6,5,5,5,2,4,4,8,5,5,5,4]
